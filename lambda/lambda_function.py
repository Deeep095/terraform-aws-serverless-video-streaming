...
def lambda_handler(event, context):
    ...
    # The describe_endpoints() response contains a list of Endpoints.
    # We must access the first item in the list to get the URL.
    ...
    output_key_prefix = os.path.splitext(key)[0]
